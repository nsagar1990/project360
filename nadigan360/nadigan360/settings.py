...
DATABASES = {
    'default': {
        ...
        'NAME': 'nadigan360',                      # Or path to database file if using sqlite3.
...
STATICFILES_DIRS = (
    #os.path.join('/root/niranjan/nadigan360/templates/', 'static'),
...
TEMPLATE_DIRS = (
    #/root/niranjan/nadigan360/templates/',
    #/home/niranjan/niranjan/nadigan360/templates'
